...
import torch
import veegan_new
import veegan_imputed
import veegan
import pandas
from joblib import load

GEN_PATH = 'VEEGAN/VEEGAN_experiment_7000epocs_adam.pt'
DATA_PATH = './data/MPEA_parsed_dataset.xlsx'
RESULT_PATH = 'VEEGAN/generatede_datasets/VEEGAN_generator_MPEA_7000epocs_model.xlsx'
