...
output_df.to_excel('VEEGAN/NSGA2_generated/NSGA2_9000epocs_model.xlsx', index=False)
...
gene_mapping_df.to_excel('VEEGAN/NSGA2_generated/NSGA2_mapping_9000epocs_model.xlsx', index=False)