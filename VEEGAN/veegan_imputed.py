...
data_df = pd.read_excel('./data/MPEA_imputed_dataset.xlsx')
...
if __name__ == "__main__":
    ...
    for epoch in range(10000):
        ...
        if epoch % 50 == 0:
            ...
            plt.savefig(f"VEEGAN/VEEGAN_lossfig_imputed_10000epocs/plot_epoch_{epoch}.svg", bbox_inches="tight")  # 'lossfig' フォルダにプロットを保存
            plt.savefig(f"VEEGAN/VEEGAN_lossfig_imputed_10000epocs/plot_epoch_{epoch}.png", bbox_inches="tight") 
            plt.close()
    ...
    torch.save(generator.state_dict(), 'VEEGAN_experiment_imputed_10000epocs.pt')